...
void main() {
  ...
  testWidgets('QrImageView generates correct image with eye style', (tester) async {
    final qrImage = MaterialApp(
      home: Center(
        child: RepaintBoundary(
          child: QrImageView(
  ...
  testWidgets('QrImageView generates correct image with eye and data module sytle',
      (tester) async {
    final qrImage = MaterialApp(
      home: Center(
        child: RepaintBoundary(
